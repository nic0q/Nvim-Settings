...
"autocmd VimEnter * NERDTree | wincmd p 	                "Comando para iniciar NERDTree al inicio
...
Plug 'Mofiqul/dracula.nvim' "My favourite
Plug 'mhartington/oceanic-next'
"SINTAXIS
Plug 'Yggdroot/indentLine' 		" indentacion
Plug 'sheerun/vim-polyglot'   " autocompletado inteligente
...
Plug 'tpope/vim-surround'               "Envuelve palabras en parentesis tipo Scheme
"ADMIN ARCHIVOS
Plug 'preservim/nerdtree'      " Administrador de archivos
Plug 'scrooloose/nerdcommenter' " Comentar rapido
Plug 'scrooloose/nerdtree'
"TERMINAL
Plug 'christoomey/vim-tmux-navigator'	"poder navegar entre archivos abiertos
Plug 'neoclide/coc.nvim', {'branch': 'release'}	"autocompletado inteligente
Plug 'alvan/vim-closetag'               "Cierra parentesis al abrir
Plug 'tpope/vim-repeat'
Plug 'junegunn/fzf'                     " Buffer, buscador
Plug 'junegunn/fzf.vim'
Plug 'mhinz/vim-signify'                 "  Marca errores en las lineas
"BUSQUEDA
...
"Configuracion de Dracula Theme
colorscheme dracula
"::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

"configuracion de emmet-vim

let g:user_emmet_leader_key=';' 	"mapeando la tecla lider por una coma, con esto se completa los tag con , y ;.
...
nnoremap <S-w> :w<CR>
nnoremap <S-q> :q<CR>
"Se mapea para abrir y cerrar NERDTree
nnoremap <S-t> :NERDTreeFind<CR> 
"Faster Scrolling
nnoremap <S-j> 10<C-e>
nnoremap <S-k> 10<C-y>
"Ejecutar un archivo de JS en nodeJS
nnoremap <S-z> :!node %<cr>
nmap <S-s> <Plug>(easymotion-s2)
" PARA NO USAR LAS FLECHAS
noremap <Up> <Nop>
noremap <Down> <Nop>
noremap <Left> <Nop>
noremap <Right> <Nop>
